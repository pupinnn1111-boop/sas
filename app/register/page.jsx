    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-emerald-50 via-white to-green-50 text-gray-800 px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Daftar untuk mengakses perpustakaan digital</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          {submitted ? (
            <div className="text-center py-6">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Registrasi Berhasil!</h3>
              <p className="text-gray-600">
                Akun berhasil dibuat dengan nama{" "}
                <span className="font-semibold text-emerald-600">{name}</span>
              </p>
              <p className="text-sm text-gray-500 mt-4">Mengarahkan ke halaman login...</p>
            </div>
          ) : (
