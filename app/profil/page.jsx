...
export default function Profil() {
  ...
  return (
    <div className="flex min-h-screen bg-linear-to-br from-emerald-50 via-white to-green-50">
      {/* Sidebar */}
      <div className="w-64 bg-white shadow-xl border-r border-gray-200 p-6 fixed left-0 top-0 h-full">
      ...
      <div className="flex-1 p-8 ml-64">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap gap-3 justify-center md:justify-start mb-4">
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-100 text-emerald-700 text-sm font-semibold">
                  {infoItems[3].icon}
                  {user.role}
                </span>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Informasi Akun</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {infoItems.map((item, idx) => (
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center bg-white rounded-xl shadow">
                  {item.icon}
                </div>
                <div>
        ...
        <div className="mt-8 flex justify-end">
          <button className="px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold shadow hover:bg-emerald-700 transition">
            Edit Profil
          </button>
        </div>
      </div>
